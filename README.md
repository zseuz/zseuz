...
### Full Stack Developer | Data Analyst & BI Specialist
...
* 💻 **Full Stack Developer & Data Specialist** with +3 years of experience building end-to-end web applications, APIs, and data-driven solutions.
* ⚙️ **Backend & Architecture:** Experienced in developing RESTful APIs, microservices, and database models using **Java (Spring Boot)**, **Python (FastAPI)**, **Node.js**, and **PHP (Laravel)**.
* 🎨 **Frontend Development:** Skilled in creating responsive, interactive user interfaces with **Angular**, **TypeScript**, **React**, and **Vue.js**.
* 📊 **Data Engineering & BI:** Specialized in **Python (Pandas)**, **Playwright** web automation, **Power BI** dashboards, and complex **SQL** optimization (SQL Server & MySQL).
* 🏥 **Domain Experience:** Proven track record in healthcare data processing (RIPS, XML, CUV) and financial/collection systems (*cartera*).
* ☁️ **DevOps & Cloud:** Configured and managed **Linux** cloud servers, cron jobs, and database infrastructure.
